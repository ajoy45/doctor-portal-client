  ...
  return (
    <div className="card  bg-base-100 shadow-xl text-center">
      <div className="card-body">
        ...
        <label htmlFor="booking-modal" className='btn  text-white bg-gradient-to-r from-primary to-secondary border-orange-50' disabled={slots.length === 0}onClick={()=>setTreatment(service)}>Book Appinment</label>
      </div>
    </div>
  );
};
